        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea placeholder="Ex. Hacking languages" className='input' {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        <SelectItem value="fermal">Fermal</SelectItem>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Estimated sestion duration in minutes</FormLabel>
                            <FormControl>
